...
<head>
    ...
    <style>
        ...
        .main-logo {
            ...
            background: linear-gradient(-45deg, rgba(109,109,109,1) 0%, rgba(37,37,37,1) 49%, rgba(1,1,23,1) 100%);
            border: none;
            border-radius: 10px;
        }
              ...
              " width="100%">
                  ...
                  " valign="top">
                                <div style="text-align: center">
                                    <button class="main-logo">B</button>
                                </div>
                    ...
                    " width="100%">
                        ...
                        " valign="top">
                          ...
                          " width="100%">
                            ...
                            margin-bottom: 15px;
                          ">
                                                Thank you for choosing BlackChat.
                                            </p>
                                        </td>
                                    </tr>
                                </table>
